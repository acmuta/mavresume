...
import { ResearchAccordion } from "../elements/accordion/ResearchAccordion";

export function ResearchSection() {
  const { addResearch } = useResumeStore();
  ...
  return (
    <div className="flex w-full items-center justify-center">
      <div className="flex w-full flex-col gap-6 px-2 py-2 sm:px-3 sm:py-3">
        <CustomSectionTitle
          title="Research"
          description="Add research roles and projects that demonstrate technical rigor, inquiry, and outcomes."
        />
