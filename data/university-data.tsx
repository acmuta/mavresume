...
export const utaEngineeringCourses = [
  ...
  {
    name: "CSE 1320",
    value: "Intermediate Programming",
    languages: ["C", "C++"],
    tools: [],
  },
  {
  ...
  },
  {
    ...
    languages: ["Python", "C++", "Scheme", "Prolog"],
    tools: [],
  },
  {
    name: "CSE 3310",
    value: "Fundamentals of Software Engineering",
  ...
  },
  {
    ...
    languages: ["C", "C++"],
    tools: ["Linux", "Unix", "VMware"],
  },
  {
    name: "CSE 3330",
    value: "Database Systems and File Structures",
    languages: ["SQL", "Python"],
    tools: ["MySQL", "PostgreSQL", "SQLite"],
  },
  {
    name: "CSE 3340",
    value: "Introduction to Human-Computer Interaction",
    languages: ["HTML", "CSS", "JavaScript"],
    tools: ["Figma", "Adobe XD"],
  },
  {
    name: "CSE 4304",
    value: "Game Design and Development",
  ...
  },
  {
    ...
    tools: ["TensorFlow", "NumPy", "scikit-learn"],
  },
  {
    name: "CSE 4309",
    value: "Fundamentals of Machine Learning",
    languages: ["Python", "R"],
    tools: ["PyTorch", "TensorFlow", "Jupyter Notebook"],
  },
  {
    name: "CSE 4310",
    value: "Fundamentals of Computer Vision",
    languages: ["Python", "C++"],
  ...
  {
    name: "CSE 4360",
    value: "Autonomous Robot Design and Programming",
    languages: ["C++", "Python"],
    tools: ["ROS", "Gazebo", "Arduino IDE"],
  },
  {
    name: "CSE 4380",
  ...
  {
    name: "ENGR 1101",
    value: "Introduction to Engineering (for transfer students)",
    languages: ["Python"],
    tools: ["MATLAB", "Excel"],
  },
  {
    name: "ENGR 1204",
    value: "Engineering First-Year Seminar",
    languages: [],
    tools: ["MATLAB", "Excel"],
  },
  {
    name: "ENGR 1250",
    value: "Problem Solving in Engineering",
    languages: ["Python"],
    tools: ["MATLAB"],
  },
  ...
  {
    name: "CE 1353",
    value: "Intro to Computer Aided Design Tools in CE",
    languages: [],
    tools: ["AutoCAD", "SolidWorks"],
  },
  {
  ...
  {
    name: "EE 1101",
    value: "Introduction to Electrical Engineering",
    languages: [],
    tools: ["MATLAB", "Multisim", "PSpice"],
  },
  {
    name: "EE 1106",
    value: "Electrical Engineering Freshman Practicum",
    languages: [],
    tools: ["MATLAB", "PSpice"],
  },
  {
    name: "EE 3302",
    value: "Fundamentals of Power Systems",
    languages: [],
    tools: ["MATLAB", "Simulink"],
  },
  {
    name: "EE 3310",
    value: "Advanced Microcontrollers",
  ...
  {
    name: "EE 4310",
    value: "Microprocessor Systems",
    languages: ["C", "C++", "Assembly"],
    tools: [],
  },
  {
    name: "EE 3446",
    value: "Circuit Analysis II",
    languages: [],
    tools: ["MATLAB", "LTSpice", "Multisim"],
  },
  {
    name: "EE 3318",
    value: "Analog & Digital Signal Processing",
    languages: ["Python", "C++"],
    tools: ["MATLAB"],
  },
  ...
  {
    name: "MAE 1107",
    value: "Introduction to Mechanical Engineering",
    languages: [],
    tools: ["SolidWorks", "MATLAB"],
  },
  {
    name: "MAE 1140",
    value: "Problems in Mechanical & Aerospace Engineering",
    languages: [],
    tools: ["MATLAB", "Excel"],
  },
  {
    ...
    languages: [],
    tools: ["SolidWorks", "MATLAB", "CAD"],
  },
  {
    name: "MAE 3324",
    value: "Materials & Structures",
    languages: [],
    tools: ["MATLAB", "Simulink"],
  },
  {
    name: "MAE 3315",
    value: "Mechanics of Materials II",
    languages: [],
    tools: ["MATLAB", "Simulink"],
  },
  {
    name: "MAE 3304",
    value: "Introduction to Fluid Mechanics",
    languages: ["Python"],
    tools: ["MATLAB"],
  },
  {
    name: "MAE 3318",
    value: "Mechanical Design I",
    languages: [],
    tools: ["SolidWorks", "ANSYS"],
  },
  {
    name: "MAE 4350",
    value: "Engineering Design Project I",
    languages: ["Python", "C++"],
    tools: ["MATLAB", "SolidWorks"],
  },
  {
    name: "MAE 4310",
    value: "Senior Design Project II",
    languages: ["C++"],
